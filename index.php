...
<script type="text/javascript" src="ffhtopo/mtmap-google.js"></script>
...
<script type="text/javascript" src="//maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&language=de"></script>
</head>
<body onload="lade()" onresize="setsize()">

	
	<div id="menubar">
		<div id="helpbar"><a href="osm.php">OpenStreetMap Ansicht</a> - <a href="ve6.php">Virtual Earth Ansicht</a> - </div>
	</div>
	<div id="content">
		<div id="sidebar"></div>
		<div id="map"></div>
